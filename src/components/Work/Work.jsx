  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl text-white font-bold uppercase">Projects</h2>
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 ">
          <div className=" bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] h-[90%] overflow-y-auto max-w-3xl overflow-hidden relative">
            {/* cross button  */}
            ...
            <div className="flex flex-col ">
              ...
              <div className="lg:p-8 p-6">
                ...
                {/* view and live buttons  */}
                <div className="flex gap-4">
                  <a
                    href={selectedProject.github}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-1/2 bg-gray-800 hover:bg-purple-800 text-gray-400 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl 
